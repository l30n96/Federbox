...
| `BIRDNET_API_URL` | Optional | URL eines laufenden [BirdNET-Analyzer](https://github.com/birdnet-team/BirdNET-Analyzer)-Servers (z.B. `https://mein-birdnet.example.com/analyze`). Ohne diese Variable ist der „Feld"-Tab (Vogelstimmen-Analyse) deaktiviert. |
